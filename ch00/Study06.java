...
//     public void sexMale(boolean male) {
//         this.male = male;
//     }
    
//     // boolean은 대신에 is를 사용할 수도 있다
//     public boolean isMale() {
//         return this.male;
//     }

//     // @Override와 같은 것들을 어노테이션(annotation)이라고 한다
//     // 주석 -> 사람이 보라고 만든 설명
...
//     // 예를 들어 @Override는 부모의 메소드를 사용하지 않고 새로운 로직을 사용하겠다라는 뜻
//     @Override
